...
export default function PostCard({id, title, date, category, description, author, viewed, full}) {
  ...
  const openClickedPostScreen = () => {
    navigation.navigate("SinglePost", {id, title, date, category, description, author, viewed});
  }
