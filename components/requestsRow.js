  ...
  return (
    <View>
        ...
        <ScrollView horizontal showsHorizontalScrollIndicator={false}>
            <RequestCard imagePath="null" title="request1" username="user1" category="category1" description="Αυτή είναι μία μεγάλη περιγραφή! Ελπίζω ότι λειτουργεί το number of lines property για να γίνει όμορφο σε όλες τις συσκευές!"/>
